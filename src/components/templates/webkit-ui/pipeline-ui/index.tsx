      ...
      <div className="z-[1] relative flex flex-col gap-sm bg-[#151b23] border border-[#656F7E] rounded-md p-md">
        {workflowActions.map((action, index) => {
          ...
          return (
            ...
            >
              {isDone ? (
                <svg data-component="Octicon" width="16" height="16" className="octicon octicon-check-circle-fill fill-[#3fb950]" aria-label="status" viewBox="0 0 16 16" version="1.1" role="img">
                  <path d="M8 16A8 8 0 1 1 8 0a8 8 0 0 1 0 16Zm3.78-9.72a.751.751 0 0 0-.018-1.042.751.751 0 0 0-1.042-.018L6.75 9.19 5.28 7.72a.751.751 0 0 0-1.042.018.751.751 0 0 0-.018 1.042l2 2a.75.75 0 0 0 1.06 0Z"></path>
                </svg>
              ) : (
                <svg aria-label="status" width="16px" height="16px" fill="none" viewBox="0 0 16 16" className="animate-spin" xmlns="http://www.w3.org/2000/svg">
